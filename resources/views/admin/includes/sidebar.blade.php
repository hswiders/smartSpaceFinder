...
<div class="deznav">
    <div class="deznav-scroll">
		<ul class="metismenu" id="menu">
            ...
            <li><a href="{{url('admin/user-list')}}" class="ai-icon" aria-expanded="false">
                    <i class="flaticon-043-menu"></i>
                    <span class="nav-text">User List</span>
                </a>
            </li>
            <!-- <li><a href="{{url('admin/client-list')}}" class="ai-icon" aria-expanded="false">
                    <i class="flaticon-043-menu"></i>
            ...
            <!-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{url('admin/addons-list')}}">Addons List</a></li>
                </ul>
            </li> -->
            <!-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    <i class="flaticon-043-menu"></i>
                ...
                <ul aria-expanded="false">
                    <li><a href="{{url('admin/plans-list')}}">Plans List</a></li>
                </ul>
            </li> -->
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    <i class="flaticon-043-menu"></i>
